...
- [x] Первый рабочий срез: live text + STT/TTS HTTP
- [ ] Все бизнес-действия, confirmation и idempotency реализованы
- [x] Offline/live/browser проверки и ограничения записаны в HANDOFF.md
- [x] Изменения main запушены после финальной проверки
