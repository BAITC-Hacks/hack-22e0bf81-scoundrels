...
- [ ] Интерфейс согласован и записан в HANDOFF.md
- [ ] STT/TTS реализованы, offline provider tests проходят
- [ ] Ограниченный live smoke на RU/KK/mixed выполнен и задокументирован
- [ ] HTTP-интеграция с ролью 2 проверена
- [ ] Реальный микрофон/динамик проверен с ролью 3
